...
public class CopyFilesByteArrayBufferedStreamTask extends AbstractCopyFilesTask {
    @Override
    protected void copyFiles(File source, File dest) throws IOException {
        try(final InputStream sourceStream = new BufferedInputStream(new FileInputStream(source));
